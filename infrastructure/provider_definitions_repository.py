...
_BUILTIN_DEFINITIONS: list[dict] = [
    # ── mailbox ──────────────────────────────────────────────────────
    {
        ...
        "description": "Custom domain mailbox based on Cloudflare Worker, requires self-deployment of Worker backend",
    ...
    },
    {
        ...
        "description": "Self-deployed temporary email, supports auto-registration or manual login of existing accounts",
    ...
    },
    {
        ...
        "label": "TempMail.lol",
        "description": "Free temporary email, ready to use out-of-the-box, no configuration required",
    ...
    },
    {
        ...
        "description": "Self-deployed email service, automatically generates temporary emails via API",
    ...
    },
    {
        ...
        "description": "Self-deployed email service, supports account password or Admin Token authentication",
    ...
    },
    {
        ...
        "description": "Testmail.app third-party service, automatically construct emails via API Key and Namespace",
    ...
    },
    {
        ...
        "description": "mail.aitre.cc free temporary email, requires specifying a fixed email address",
    ...
    },
    {
        ...
        "description": "DuckDuckGo Email Protection, generates @duck.com aliases, retrieves verification codes from forwarding email via IMAP",
        ...
        "fields": [
            ...
            {"key": "ddg_imap_user", "label": "IMAP Username (Forwarding Email)", "placeholder": "your@gmail.com", "category": "auth"},
    ...
    },
    {
        ...
        "label": "Local Microsoft Email Pool",
        "description": "Import Xinlan email assistant universal format account pool, prioritize Client Id + refresh token via Microsoft Graph to receive verification codes",
        ...
        "fields": [
            {
                ...
                "category": "connection",
                "hint": "Optional; one entry per line in Xinlan email assistant universal format. After configuring the path, no need to paste plaintext accounts into settings.",
            },
            {
                ...
                "type": "textarea",
                "category": "auth",
                "hint": "Optional; directly paste Xinlan email assistant universal format. Supports comma, Chinese comma, TAB, ---- separators.",
            },
            {
            ...
            },
            {
                ...
                "label": "Occupancy Status File",
                "placeholder": "Default data/.local_ms_mailbox_pool_state.json",
                "category": "connection",
                "hint": "Used to avoid assigning the same email repeatedly; clearing this file resets the account pool occupancy state.",
            },
            {
                "key": "local_ms_pool_allow_reuse",
                "label": "Allow Email Reuse",
                "type": "toggle",
                "category": "connection",
    ...
    },
    {
        ...
        "description": "Integrate arbitrary email APIs by configuring HTTP endpoints and authentication, suitable for advanced users",
    ...
    # ── captcha ──────────────────────────────────────────────────────
    {
        ...
        "label": "YesCaptcha",
        "description": "YesCaptcha cloud captcha solving service, supports Turnstile, etc.",
    ...
    },
    {
        ...
        "label": "2Captcha",
        "description": "2Captcha cloud captcha solving service, supports Turnstile, etc.",
    ...
    },
    {
        ...
        "description": "Call local api_solver service (Camoufox/patchright) to solve Turnstile captcha",
    ...
    },
    {
        ...
        "description": "Block and wait for user to manually input captcha, suitable for debugging",
        "driver_type": "manual",
        "default_auth_mode": "",
        "enabled": True,
        "category": "thirdparty",
    ...
    # ── sms ──────────────────────────────────────────────────────────
    {
        ...
        "label": "HeroSMS",
        "description": "HeroSMS SMS receiving platform, supports number reuse and automatic resend",
        ...
        "fields": [
            ...
            {"key": "herosms_default_country", "label": "Default Country", "type": "async-select", "asyncUrl": "/sms/herosms/countries", "asyncValueKey": "id", "asyncLabelKey": "chn", "placeholder": "Please select country..."},
            {"key": "herosms_default_service", "label": "Default Service", "type": "async-select", "asyncUrl": "/sms/herosms/services", "asyncValueKey": "code", "asyncLabelKey": "name", "placeholder": "Please select service..."},
            {"key": "herosms_max_price", "label": "Maximum Price (Optional)", "placeholder": "-1"},
            ...
            {"key": "herosms_auto_country_min_stock", "label": "Auto-selection Minimum Stock", "placeholder": "20"},
            {"key": "herosms_auto_country_max_price", "label": "Auto-selection Maximum Price", "placeholder": "0 (Unlimited)"},
            {"key": "register_phone_extra_max", "label": "Number Reuse Extra Limit", "placeholder": "3"},
            {"key": "register_reuse_phone_to_max", "label": "Reuse Number to Maximum", "type": "toggle"},
        ],
    },
    {
        "provider_type": "sms",
        ...
        "label": "SMS-Activate",
        "description": "SMS-Activate SMS receiving platform (sms-activate.guru)",
    ...
    },
    {
        ...
        "label": "SMSBower",
        "description": "SMSBower SMS receiving platform, API compatible with HeroSMS, supports number reuse and automatic resend",
        ...
        "fields": [
            ...
            {"key": "smsbower_default_country", "label": "Default Country", "type": "async-select", "asyncUrl": "/sms/smsbower/countries", "asyncValueKey": "id", "asyncLabelKey": "chn", "placeholder": "Please select country..."},
            {"key": "smsbower_default_service", "label": "Default Service", "type": "async-select", "asyncUrl": "/sms/smsbower/services", "asyncValueKey": "code", "asyncLabelKey": "name", "placeholder": "Please select service..."},
            {"key": "smsbower_max_price", "label": "Maximum Price (Optional)", "placeholder": "-1"},
    ...
    # ── proxy ────────────────────────────────────────────────────────
    {
        ...
        "description": "Dynamically extract proxy IP lists via HTTP API, suitable for API extraction interfaces of most proxy providers",
