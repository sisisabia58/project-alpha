  ...
  return (
    <section>
      ...
      <p className="mt-1 text-sm text-[var(--text-muted)]">
        Customize each platform's supported executors, registration identity, and third-party providers.
      </p>
          ...
          return (
            ...
            >
              ...
              <div className="space-y-3">
                <div>
                  <p className="mb-2 text-xs text-[var(--text-muted)]">Executors</p>
                ...
                <div>
                  <p className="mb-2 text-xs text-[var(--text-muted)]">Identity</p>
                ...
                <div>
                  <p className="mb-2 text-xs text-[var(--text-muted)]">Third-party Providers</p>
                  <div className="flex flex-wrap gap-4">
