...
function GeneralTab({
  ...
  const oauthOptions = [
    { label: 'No default, select on page', value: '' },
    ...((configOptions?.oauth_provider_options || []).filter((o) => o.value !== '')),
  ]

  return (
    <div className="space-y-8">
      <SettingGroup title="Appearance" desc="Choose the app theme. Takes effect immediately.">
      ...
      <SettingGroup
        ...
        desc="These are the default settings. The accounts page and register page will reuse them."
      >
      ...
      <SettingGroup
        title="Browser Reuse"
        desc="Third-party accounts using background browser automation usually need to reuse the local logged-in browser."
      >
        <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-card)] divide-y divide-[var(--border)]/50">
          ...
          <SettingRow label="Chrome CDP URL">
            <input
              type="text"
...
function AboutTab() {
  ...
  return (
    <div className="space-y-8">
      <SettingGroup title="Version Info" desc="Current app version and update check.">
        <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-card)] divide-y divide-[var(--border)]/50">
            ...
            <div className="space-y-3 px-4 py-4">
              ...
              {info.latest.published_at && (
                <div className="text-xs text-[var(--text-muted)]">
                  Published {new Date(info.latest.published_at).toLocaleDateString('en-US')}
                </div>
              )}
              <Button
                size="sm"
      ...
      <SettingGroup title="Project Info">
        <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-card)] divide-y divide-[var(--border)]/50">
          <InfoRow label="Project" value="Any Auto Register" />
