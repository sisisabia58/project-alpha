...
export default function TaskHistory() {
  ...
  const metricCards = [
    { label: 'Total', value: tasks.length, icon: Activity, tone: 'text-[var(--accent)]' },
    { label: 'Success', value: succeeded, icon: CheckCircle2, tone: 'text-emerald-500' },
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[var(--border)] bg-[var(--bg-pane)]">
                ...
                <th className="px-4 py-2.5 text-left text-xs font-medium text-[var(--text-muted)]">Success/Fail</th>
